...
SHORT_NAME = "OpenET - US"
# Title of the collection
TITLE = "US Field Boundaries from OpenET"
# Description of the collection. Can be multiline and include CommonMark.
DESCRIPTION = """Field Boundaries for the US from the OpenET dataset."""
...
ADD_COLUMNS = {
  "determination_method": "adminstrative"
}
